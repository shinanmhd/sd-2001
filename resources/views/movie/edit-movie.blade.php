            ...
            <div class="px-4 py-6 sm:px-0">
                ...
                <div class="grid place-items-center">
                    <div class="bg-white w-full border p-12">
                        <h1 class="text-xl font-semibold mb-6">Please fill in the information for the movie</h1>
                        <form class="mt-6" method="post" action="{{ route('movie.update', ['movie' => $movie]) }}">
                            @csrf
                            @method('PUT')
                            <div class="flex justify-between gap-3 mb-6">
                                <span class="w-full flex flex-col">
                                    ...
                                    <input id="name" type="text" name="name" placeholder="Movie Name" class="block w-full p-3 mt-2 text-gray-700 bg-gray-200 appearance-none focus:outline-none focus:bg-gray-300 focus:shadow-inner" value="{{ $movie->name }}" />
                            ...
                            <div class="flex justify-between gap-3 mb-6">
                                <span class="w-1/2 flex flex-col">
                                    ...
                                    <input id="release_date" type="date" name="release_date" placeholder="Release Date" class="block w-full p-3 mt-2 text-gray-700 bg-gray-200 appearance-none focus:outline-none focus:bg-gray-300 focus:shadow-inner" value="{{ $movie->release_date }}" />
                                ...
                                <span class="w-1/2 flex flex-col">
                                    ...
                                    <input id="date_added" type="date" name="date_added" placeholder="Added Date" class="block w-full p-3 mt-2 text-gray-700 bg-gray-200 appearance-none focus:outline-none focus:bg-gray-300 focus:shadow-inner" value="{{ $movie->date_added }}" />
                            ...
                            <div class="flex justify-between gap-3 mb-6">
                                <span class="w-1/2 flex flex-col">
                                    ...
                                    <input id="no_in_stock" type="number" name="no_in_stock" class="block w-full p-3 mt-2 text-gray-700 bg-gray-200 appearance-none focus:outline-none focus:bg-gray-300 focus:shadow-inner" value="{{ $movie->no_in_stock }}" />
