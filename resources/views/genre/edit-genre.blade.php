            ...
            <div class="px-4 py-6 sm:px-0">
                ...
                <div class="grid place-items-center">
                    <div class="bg-white w-full border p-12">
                        ...
                        <form class="mt-6" method="post" action="{{ route('genre.update', ['genre' => $genre]) }}">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="flex justify-between gap-3 mb-6">
                                <span class="w-full flex flex-col">
                                    ...
                                    <input id="name" type="text" name="name" placeholder="Genre Name" class="block w-full p-3 mt-2 text-gray-700 bg-gray-200 appearance-none focus:outline-none focus:bg-gray-300 focus:shadow-inner" value="{{ $genre->name }}" />
